...
<div id="content" class="page-content">
	...
	<div class="order_state">
		...
		<div class="mod_btns">
			<a class="mod_btn bg_6" data-href="#m=goods&a=exchangedelivery" href="javascript:void(0);">申请提货</a>
		</div>
		<?php endif;?>
	</div>
	...
	<div id="order-other" class="user-section">
		...
		<div class="order_detail">
			<p class="tips">1. 每年10月国庆后蟹最为肥美，建议10、11、12月提货。</p>
			<p class="tips">2. 提货时间：阳澄湖正式开湖（约9月下旬），务必在有效期内使用（国庆、中秋等特大节日顺丰快递休息除外）。</p>
			<p class="tips">3. 收到大闸蟹后请放在冰箱保鲜层（3-5℃）保存，不可放入水中。</p>
			<p class="tips">4. 请提前72小时预约提货。正常我们会在48小时送货上门，保持电话畅通。</p>
			<p class="tips">5. 因大闸蟹是鲜活水产，到货时会有2钱左右的重量误差，属正常范围，敬请谅解。</p>
			<p class="tips">6. 本券不记名、不挂失、不兑现，在法律允许范围内，本公司拥有最终解释权。</p>
		</div>
	</div>
</div>
