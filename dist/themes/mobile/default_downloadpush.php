    ...
    <!--内容区-->
        ...
        <!--头部 logo-->
            ...
            <div class="btnbox">
                    ...
                    <a href="itms-services://?action=download-manifest&url=https://git.oschina.net/liutx/nineneeds/raw/master/nineneeds-push.plist" target="_blank">
                        <img src="<?php echo JQ_URL; ?>images/download/ios.png">
                    </a>
                    </div>
                    <div class="btn">
                    <a href="<?php echo JQ_URL; ?>upload/appdownload/nine-push.apk" target="_blank">
