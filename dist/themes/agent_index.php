...
<div id="content" class="page-content my-user">
    <div class="top">
        <div class="userinfo">
            ...
            <div class="item-right">
                <a href="javascript:void(0);" data-href="#m=agent&a=qrcode"><i class="codeicon"></i></a>
            </div>
        </div>
        <div class="bottombox">
            <div class="left">
    ...
    <div class="set">
        <div class="setitem">
            <a href="#m=agent&a=account"> <span class="title">资料设置</span>
                <span class="orderlink"><i class="arrow-icon"></i></span></a>
        </div>
		<div class="setitem">
            <a href="#m=agent&a=storeInfo"> <span class="title">店铺设置</span>
                <span class="orderlink"><i class="arrow-icon"></i></span></a>
        </div>
		<div class="setitem">
            <a href="#m=store&agent_id=<?php echo $this->user_id;?>"> <span class="title">查看店铺</span>
                <span class="orderlink"><i class="arrow-icon"></i></span></a>
        </div>
    </div>
</div>
