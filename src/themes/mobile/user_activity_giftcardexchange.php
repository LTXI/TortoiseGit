...
<div id="content" class="page-content">
	...
	<form data-action="m=user&c=activity&a=giftcardexchange" action="" method="post" name="app-submit">
		<div class="address_new" id="pageAddAddress">
			...
			<div class="mod_btns">
				...
				<a href="javascript:void(0);" data-href="#m=user&c=activity&a=giftcardinfo&card_id=<?php echo $this->card_id; ?>" class="mod_btn">取消</a>
			</div>
		</div>
