...
<div id="content" class="page-content">
	<div class="order-topbar">
		<div class="topbar-tabs">
			<ul id="nav">
				<li><a href="#m=user&c=affiliate&a=orders">全部订单</a></li>
				<li class="cur"><a href="#m=user&c=affiliate&a=uncheck">待审订单</a></li>
				<li><a href="#m=user&c=affiliate&a=checkout">已结订单</a></li>
			</ul>
		</div>
	</div>
